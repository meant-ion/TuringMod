...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi_1.BaseApi {
    ...
    async subscribeToChannelSubscriptionGiftEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.gift', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionMessageEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.message', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.end', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelModeratorAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.moderator.add', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelModeratorRemoveEvents(broadcaster, transport) {
        return await this.createSubscription('channel.moderator.remove', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPollBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.begin', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPollProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.progress', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPollEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.end', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.begin', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.progress', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionLockEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.lock', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.end', '1', { broadcaster_user_id: common_1.extractUserId(broadcaster) }, transport);
    }
    /**

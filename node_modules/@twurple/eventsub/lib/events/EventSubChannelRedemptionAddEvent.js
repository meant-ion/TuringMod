...
let EventSubChannelRedemptionAddEvent = class EventSubChannelRedemptionAddEvent extends common_1.DataObject {
     ...
     */
    async getReward() {
        return (await this._client.channelPoints.getCustomRewardById(this[common_1.rawDataSymbol].broadcaster_user_id, this[common_1.rawDataSymbol].reward.id));
    }
    /**
...
EventSubChannelRedemptionAddEvent = tslib_1.__decorate([
    common_1.rtfm('eventsub', 'EventSubChannelRedemptionAddEvent', 'id')

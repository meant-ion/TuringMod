...
var Router = /** @class */ (function () {
    ...
    Router.prototype.use = function (path) {
        ...
        if (callbacks.length) {
            var _a = __read(pathToRegex(path, false), 3), regex = _a[0], paramNames = _a[1], componentsToDrop = _a[2];
    ...
    Router.prototype.add = function (method, path) {
        ...
        if (callbacks.length) {
            var _a = __read(pathToRegex(path), 2), regex = _a[0], paramNames = _a[1];
            ...
            if (!method || method === requestMethod || (isHead && method === 'GET')) {
                if (paramNames.length) {
                    ...
                    if (matches) {
                        ...
                        var i = 1;
                        try {
                            for (var paramNames_1 = (e_2 = void 0, __values(paramNames)), paramNames_1_1 = paramNames_1.next(); !paramNames_1_1.done; paramNames_1_1 = paramNames_1.next()) {
                        ...
                        foundCallbacks.push.apply(foundCallbacks, __spread(callbacks.map(function (callback) { return ({ params: params_1, callback: callback, componentsToDrop: componentsToDrop }); })));
                    }
                }
                else if (regex.test(requestPath)) {
                    foundCallbacks.push.apply(foundCallbacks, __spread(callbacks.map(function (callback) { return ({ params: {}, callback: callback, componentsToDrop: componentsToDrop }); })));
                }
            }
        };
        try {

...
var BaseOBSWebSocket = /*#__PURE__*/function (_EventEmitter) {
  ...
  _proto.callBatch = function callBatch(requests, options) {
    ...
    try {
      ...
      return Promise.resolve(_this12.message(exports.WebSocketOpCode.RequestBatch, _extends({
        requestId: requestId,
        requests: requests
  ...
  _proto.createConnection = function createConnection(url) {
    try {
      ...
      var helloPromise = _this14.internalEventPromise("op:" + exports.WebSocketOpCode.Hello);

      _this14.socket = new WebSocketIpml__default["default"](url, _this14.protocol);
  ...
  _proto.identify = function identify(_ref3, password, identificationParams) {
    ...
    try {
      ...
      var identifiedPromise = _this16.internalEventPromise("op:" + exports.WebSocketOpCode.Identified);

      return Promise.resolve(_this16.message(exports.WebSocketOpCode.Identify, data)).then(function () {

...
var BaseOBSWebSocket = /*#__PURE__*/function (_EventEmitter) {
  ...
  _proto.disconnect = function disconnect() {
    try {
      ...
      if (!_this6.socket || _this6.socket.readyState === WebSocketIpml__default["default"].CLOSED) {
  ...
  _proto.reidentify = function reidentify(data) {
    try {
      ...
      var identifiedPromise = _this8.internalEventPromise("op:" + exports.WebSocketOpCode.Identified);

      return Promise.resolve(_this8.message(exports.WebSocketOpCode.Reidentify, data)).then(function () {
  ...
  _proto.call = function call(requestType, requestData) {
    try {
      ...
      return Promise.resolve(_this10.message(exports.WebSocketOpCode.Request, {
        requestId: requestId,
  ...
  _proto.createConnection = function createConnection(url) {
    try {
      ...
      var helloPromise = _this12.internalEventPromise("op:" + exports.WebSocketOpCode.Hello);

      _this12.socket = new WebSocketIpml__default["default"](url, _this12.protocol);
  ...
  _proto.identify = function identify(_ref2, password, identificationParams) {
    ...
    try {
      ...
      var identifiedPromise = _this14.internalEventPromise("op:" + exports.WebSocketOpCode.Identified);

      return Promise.resolve(_this14.message(exports.WebSocketOpCode.Identify, data)).then(function () {
...
}(EventEmitter__default["default"]); // https://github.com/developit/microbundle/issues/531#issuecomment-575473024
